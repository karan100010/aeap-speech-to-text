...
class GoogleProvider extends Writable {
	...
	_write(chunk, encoding, callback) { 
		this.chunks = this.chunks || []; // Initialize chunks array if not already initialized
		this.chunks.push(chunk.data); // Add the current chunk to the array
